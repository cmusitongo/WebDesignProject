function lifeTest() {
	...
	alert("Please rate each question from 1 to 5");

	var choice1 = parseInt(prompt("I see the glass as half full. (Rate from 1 to 5)"));
	var choice2 = parseInt(prompt("When I see an opportunity I take it. (Rate from 1 to 5)"));
	var choice3 = parseInt(prompt("When I don't know something I say to myself that I can't do it. (Rate from 1 to 5)"));
	var choice4 = parseInt(prompt("I treat others with respect as long as they return the favour. (Rate from 1 to 5)"));
	var choice5 = parseInt(prompt("I have an idea where I'll be in the future. (Rate from 1 to 5)"));
